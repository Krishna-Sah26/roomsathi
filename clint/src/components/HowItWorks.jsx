...
function HowItWorks() {
  ...
  return (
    <section className={theme === "dark" ? "bg-slate-900 px-4 py-16 md:py-20" : "bg-[#f1f0ff] px-4 py-16 md:py-20"}>
      <div className="mx-auto max-w-7xl text-center">
        ...
        <div className="mt-10 grid grid-cols-1 gap-5 md:grid-cols-3">
          <div className={theme === "dark" ? "rounded-2xl bg-slate-950 p-8 shadow-sm ring-1 ring-slate-800" : "rounded-2xl bg-white p-8 shadow-sm ring-1 ring-slate-200"}>
            <div className="mx-auto mb-5 flex h-12 w-12 items-center justify-center rounded-2xl bg-blue-50 text-blue-700">
              <Search size={22} />
            </div>
            <h3 className={theme === "dark" ? "mb-2 text-lg font-semibold text-white" : "mb-2 text-lg font-semibold text-slate-900"}>1. Search</h3>
          ...
          <div className={theme === "dark" ? "rounded-2xl bg-slate-950 p-8 shadow-sm ring-1 ring-slate-800" : "rounded-2xl bg-white p-8 shadow-sm ring-1 ring-slate-200"}>
            ...
            <h3 className={theme === "dark" ? "mb-2 text-lg font-semibold text-white" : "mb-2 text-lg font-semibold text-slate-900"}>2. Visit</h3>
            <p className={theme === "dark" ? "text-sm leading-6 text-slate-400" : "text-sm leading-6 text-slate-500"}>
          ...
          <div className={theme === "dark" ? "rounded-2xl bg-slate-950 p-8 shadow-sm ring-1 ring-slate-800" : "rounded-2xl bg-white p-8 shadow-sm ring-1 ring-slate-200"}>
            ...
            <h3 className={theme === "dark" ? "mb-2 text-lg font-semibold text-white" : "mb-2 text-lg font-semibold text-slate-900"}>3. Move In</h3>
            <p className={theme === "dark" ? "text-sm leading-6 text-slate-400" : "text-sm leading-6 text-slate-500"}>
