...
function Hero({ search, onSearch }) {
  return (
    <section
      className="relative flex min-h-[620px] items-center justify-center overflow-hidden bg-slate-950 bg-cover bg-center bg-no-repeat px-4 pt-24 md:min-h-[720px]"
      style={{
        backgroundImage:
    ...
    >
      ...
      <div className="relative z-10 w-full px-2 text-center text-white">
        <div className="mx-auto max-w-4xl">
          <h1 className="text-4xl font-bold leading-tight drop-shadow-md md:text-6xl md:leading-[1.05]">
            Find Your Ideal Home in Birgunj
          </h1>
          <p className="mx-auto mt-5 max-w-2xl text-sm leading-6 text-slate-100/95 md:text-base md:leading-7">
